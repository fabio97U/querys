...
('R07951'), ('067671'), ('070717')

select vst.transa_codigo codtransa, vst.per_carnet 'Carnet', vst.per_apellidos_nombres 'Nombre completo', per.per_dui 'DUI', per.per_nit 'NIT', 
