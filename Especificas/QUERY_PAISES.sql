/*drop table ra_paie_pais_estado
go
drop table ra_pai_paises_ref
go*/
CREATE TABLE ra_pai_paises_ref (
  pai_codigo int primary key,
  pai_pais varchar(250),
  pai_nacionalidad varchar(250)
); 
go
 
insert into ra_pai_paises_ref (pai_codigo, pai_pais, pai_nacionalidad) values
(1, 'Australia', 'Australiano'),
(2, 'Austria', 'Austriaco'),
(3, 'Azerbaiy·n', 'Azerbaiyano'),
(4, 'Anguilla', 'Anguilano'),
(5, 'Argentina', 'Argentino'),
(6, 'Armenia', 'Armenio'),
(7, 'Bielorrusia', 'Bielorruso'),
(8, 'Belice', 'BeliceÒo'),
(9, 'BÈlgica', 'Belga'),
(10, 'Bermudas', 'Bermudo'),
(11, 'Bulgaria', 'B˙lgaro'),
(12, 'Brasil', 'BrasileÒo'),
(13, 'Reino Unido', 'Londres'),
(14, 'HungrÌa', 'H˙ngaro'),
(15, 'Vietnam', 'Vietnamita'),
(16, 'HaitÌ', 'Haitiano'),
(17, 'Guadalupe', 'Guadalupano'),
(18, 'Alemania', 'Alem·n'),
(19, 'PaÌses Bajos, Holanda', 'HolandÈs'),
(20, 'Grecia', 'Griego'),
(21, 'Georgia', 'Georgia'),
(22, 'Dinamarca', 'DanÈs'),
(23, 'Egipto', 'Egipcio'),
...
(29, 'Italia', 'Italiano'),
(30, 'Kazajst·n', 'Kazajo'),
(31, 'Camer˙n', 'CamerunÈs'),
(32, 'Canad·', 'Canadiense'),
(33, 'Chipre', 'Chipriota'),
(34, 'Kirguist·n', 'KirguÌs'),
(35, 'China', 'Chino' ),
(36, 'Costa Rica', 'Costarricense'),
(37, 'Kuwait', 'KuwaitÌ'),
(38, 'Letonia', 'LetÛn'),
(39, 'Libia',  'Libio'),
(40, 'Lituania', 'Lituano'),
(41, 'Luxemburgo', 'LuxemburguÈs'),
(42, 'MÈxico', 'Mexicano'),
(43, 'Moldavia', 'Moldavo'),
(44, 'MÛnaco', 'Monegasco'),
(45, 'Nueva Zelanda', 'NeozelandÈs'),
(46, 'Noruega', 'Noruego'),
(47, 'Polonia', 'Polaco' ),
(48, 'Portugal', 'PortuguÈs'),
(49, 'Saint-Denis', 'Saint-Denis'),
(50, 'Rusia', 'Ruso'),
(51, 'El Salvador', 'SalvadoreÒo'),
(52, 'Eslovaquia', 'Eslovaco'),
(53, 'Eslovenia','Esloveno'),
(54, 'Surinam', 'Surinam'),
(55, 'Estados Unidos', 'Estadunidense'),
(56, 'Tadjikistan','Tadjikistan'),
(57, 'Turkmenist·n', 'Turkmenist·n'),
(58, 'Islas Turcas y Caicos', 'Islas Turcas y Caicos'),
(59, 'TurquÌa', 'Turco'),
(60, 'Uganda', 'Uganda'),
(61, 'Uzbekist·n', 'Uzbekist·n'),
(62, 'Ucrania', 'Ucraniano'),
(63, 'Finlandia', 'FinlandÈs'),
(64, 'Francia', 'FrancÈs'),
(65, 'Rep˙blica Checa', 'Checo'),
(66, 'Suiza', 'Suizo'),
(67, 'Suecia', 'Sueco'),
(68, 'Estonia', 'Estonia'),
(69, 'Corea del Sur', 'Coreano'),
(70, 'JapÛn', 'JaponÈs'),
(71, 'Croacia', 'Croata'),
(72, 'RumanÌa', 'Rumano'),
(73, 'Hong Kong', 'Rep˙blica Popular de China'),
(74, 'Indonesia', 'Indonesio'),
(75, 'Jordania', 'Palestino'),
(76, 'Malasia', 'Malasio'),
(77, 'Singapur', 'Singapurenses'),
(78, 'Taiw·n', 'TailandÈs'),
(79, 'Bosnia y Herzegovina', 'Herzegovina'),
(80, 'Bahamas', 'Antillas o Islas del Caribe'),
(81, 'Chile', 'Chileno'),
(82, 'Colombia', 'Colombiano'),
(83, 'Islandia', 'IslandÈs'),
(84, 'Corea del Norte', 'Coreano' ),
(85, 'Macedonia', 'Rep˙blica de Macedonia'),
(86, 'Malta', 'Malta'),
(87, 'Pakist·n', 'PakistanÌ'),
(88, 'Pap˙a-Nueva Guinea', 'Nueva Guinea'),
(89, 'Per˙', 'Peruano'),
(90, 'Filipinas', 'Filipino'),
(91, 'Arabia Saudita', 'Saudita'),
(92, 'Tailandia', 'TailandÈs'),
(93, 'Emiratos ·rabes Unidos', 'Emirato'),
(94, 'Groenlandia', 'GroenlandÈs'),
(95, 'Venezuela', 'Venezolano'),
(96, 'Zimbabue', 'Zimbabue'),
(97, 'Kenia', 'Africano'),
(98, 'Algeria','Argelino'),
(99, 'LÌbano', 'LibanÈs' ),
(100, 'Botsuana', 'Botsuana'),
(101, 'Tanzania', 'Tanzano'),
(102, 'Namibia', 'Namibia'),
(103, 'Ecuador', 'Ecuatoriano'),
(104, 'Marruecos', 'MarroquÌ'),
(105, 'Ghana', 'GhanÈs'),
(106, 'Siria', 'Sirio'),
(107, 'Nepal', 'Nepal'),
(108, 'Mauritania', 'Mauritania'),
(109, 'Seychelles', 'Seychellense'),
(110, 'Paraguay', 'Paraguayo'),
(111, 'Uruguay', 'Uruguayo'),
(112, 'Congo (Brazzaville)','Brazzaville'),
(113, 'Cuba', 'Cubano'),
(114, 'Albania','Albania'),
(115, 'Nigeria', 'Nigeriano'),
(116, 'Zambia', 'Zambiano'),
(117, 'Mozambique','Mozambican'),
(119, 'Angola', 'Angolano'),
(120, 'Sri Lanka', 'Sri Lankan'),
(121, 'EtiopÌa', 'EtÌope'),
(122, 'T˙nez', 'Tunecino'),
(123, 'Bolivia', 'Boliviano'),
(124, 'Panam·', 'PanameÒo'),
(125, 'Malawi','MalauÌ '),
(126, 'Liechtenstein','Liechtensteiner'),
(127, 'BahrÈin', 'BahreinÌ'),
(128, 'Barbados','Barbadense'),
(130, 'Chad','Chadiano'),
(131, 'Man, Isla de','Manx'),
(132, 'Jamaica', 'Jamaicano'),
(133, 'MalÌ', 'Maliense'),
(134, 'Madagascar','Malagasy'),
(135, 'Senegal','Senegaleses'),
(136, 'Togo','Togoles'),
(137, 'Honduras', 'HondureÒo'),
(138, 'Rep˙blica Dominicana', 'Dominicano'),
(139, 'Mongolia', 'Mongolia'),
(140, 'Irak', 'IraquÌ'),
(141, 'Sud·frica', 'Sudafricano'),
(142, 'Aruba', 'Araban'),
(143, 'Gibraltar', 'GibraltareÒo'),
(144, 'Afganist·n', 'Afgano'),
(145, 'Andorra',' Andorrano'),
(147, 'Antigua y Barbuda', 'Antiguan Barbudan'),
(149, 'Bangladesh','BangladesÌ'),
(151, 'BenÌn', 'BeninÈs'),
(152, 'But·n', 'ButanÈs'),
(154, 'Islas VÌrgenes Brit·nicas','Virgin Islander'),
(155, 'BrunÈi', 'Bruneano'),
(156, 'Burkina Faso','BurkinÈs'),
(157, 'Burundi', 'Burundi'),
(158, 'Camboya', 'Camboyano'),
(159, 'Cabo Verde', 'Cabo Verdeano'),
(164, 'Comoros','Comorano'),
(165, 'Congo (Kinshasa)','Congo (Kinshasa)'),
(166, 'Cook, Islas', 'Cook Islander'),
(168, 'Costa de Marfil', 'MarfileÒo'),
(169, 'Djibouti, Yibuti', 'Yibutiano'),
(171, 'Timor Oriental', 'Timorense'),
(172, 'Guinea Ecuatorial', 'Ecuatoguineano'),
(173, 'Eritrea','Eritreo'),
(175, 'Feroe, Islas', 'FeroÈs'),
(176, 'Fiyi', 'Fiyiano'),
(178, 'Polinesia Francesa', 'Polinesia Francesa'),
(180, 'GabÛn', 'GabonÈs'),
(181, 'Gambia', 'Gambiano'),
(184, 'Granada', 'Granadino'),
(185, 'Guatemala', 'Guatemalteco'),
(186, 'Guernesey', 'Guernesey'),
(187, 'Guinea', 'Guineano'),
(188, 'Guinea-Bissau','Bisauguineano'),
(189, 'Guyana', 'GuyanÈs'),
(193, 'Jersey', 'Jersey'),
(195, 'Kiribati', 'Kiribatiano'),
(196, 'Laos', 'Laosiano'),
(197, 'Lesotho', 'Lesotense'),
(198, 'Liberia', 'Liberiano'),
(200, 'Maldivas', 'Maldivo'),
(201, 'Martinica', 'Matinico'),
(202, 'Mauricio', 'Mauriciano'),
(205, 'Myanmar', 'Myamaro'),
(206, 'Nauru', 'Nauru'),
(207, 'Antillas Holandesas', 'Antillas Holandesas'),
(208, 'Nueva Caledonia', 'Nueva Caledonia'),
(209, 'Nicaragua', 'Nicarag¸ense'),
(210, 'NÌger', 'Nigeriano'),
...
(216, 'Qatar', 'QatarÌ'),
(217, 'Ruanda', 'Ruanda'),
(218, 'San Pedro', 'San Pedro'),
(219, 'San CristÛbal y Nevis', 'San CristÛbal y Nevis'),
(220, 'Santa LucÌa', 'Santa LucÌa'),
(221, 'San Pedro y MiquelÛn', 'San Pedro y MiquelÛn'),
(222, 'San Vicente y Granadinas', 'San Vicente y Granadinas'),
(223, 'Samoa', 'Samoano'),
(224, 'San Marino', 'Sanmarinense'),
(225, 'San TomÈ y PrÌncipe', 'Santotomense'),
(226, 'Serbia y Montenegro', 'Serbia y Montenegro'),
(227, 'Sierra Leona', 'SierraleonÈs'),
(228, 'Islas SalomÛn', 'Salomonense'),
(229, 'Somalia', 'SomalÌ'),
(232, 'Sud·n', 'SudanÈs'),
(234, 'Swazilandia', 'Suazi'),
(235, 'Tokelau', 'Tokelauano'),
(236, 'Tonga', 'Tongano'),
(237, 'Trinidad y Tobago', 'Trinitense'),
(239, 'Tuvalu', 'Tuvaluano'),
(240, 'Vanuatu', 'Vanuatuense'),
(241, 'Wallis y Futuna', 'Wallisian Futunan'),
(242, 'S·hara Occidental', 'S·hara Occidental'),
(243, 'Yemen', 'YemenÌ'),
(246, 'Puerto Rico', 'PuertorriqueÒo');


CREATE TABLE  ra_paie_pais_estado (
  paie_codigo int primary key,
  paie_codpai int foreign key references ra_pai_paises_ref,
  paie_nombre_estado varchar(255)
);
go

INSERT INTO ra_paie_pais_estado (paie_codigo, paie_codpai, paie_nombre_estado) VALUES
(1, 3, 'Azerbaijan'),
...
(432, 64, 'Corse'),
(433, 64, 'Cocircte dOr'),
(434, 64, 'Saocircne et Loire'),
(435, 64, 'Cocirctes dArmor'),
(436, 64, 'Creuse'),
(437, 64, 'Doubs'),
(438, 64, 'Dr&ocirc;me'),
(439, 64, 'Eure'),
...
(477, 64, 'PyrÈnÈes-Atlantiques'),
(478, 64, 'Hautes-PyrÈnÈes'),
(479, 64, 'PyrÈnÈes-Orientales'),
(480, 64, 'Bas Rhin'),
(481, 64, 'Haut Rhin'),
...
(545, 29, 'Emilia Romagna - ForlÏ-Cesena'),
...
(865, 2, 'Burgenland'),
(866, 2, 'K‰rnten'),
(867, 2, 'Niederˆsterreich'),
(868, 2, 'Oberˆsterreich'),
(869, 2, 'Salzburg'),
(870, 2, 'Steiermark'),
(871, 2, 'Tirol'),
(872, 2, 'Vorarlberg'),
...
/*
drop table ra_paie_pais_estado
select * from ra_paie_pais_estado
CREATE TABLE  ra_paie_pais_estado (
  paie_codigo int primary key,
  paie_codpai int foreign key references ra_pai_paises_ref,
  paie_nombre_estado varchar(255)
...
(1662, 81, 'RegiÛn de Tarapac·'),
(1663, 81, 'RegiÛn de Antofagasta'),
(1664, 81, 'RegiÛn de Atacama'),
(1665, 81, 'RegiÛn de Coquimbo'),
(1666, 81, 'RegiÛn de ValparaÌso'),
(1667, 81, 'RegiÛn del Libertador General Bernardo OHiggins'),
(1668, 81, 'RegiÛn del Maule'),
(1669, 81, 'RegiÛn del BÌo BÌo'),
(1670, 81, 'RegiÛn de La AraucanÌa'),
(1671, 81, 'RegiÛn de Los Lagos'),
(1672, 81, 'RegiÛn AisÈn del General Carlos Ib·Òez del Campo'),
(1673, 81, 'RegiÛn de Magallanes y de la Ant·rtica Chilena'),
(1674, 81, 'RegiÛn Metropolitana de Santiago'),
...
(1689, 185, 'QuichÈ'),
(1690, 185, 'Retalhuleu'),
(1691, 185, 'SacatepÈquez'),
(1692, 185, 'San Marcos'),
(1693, 185, 'Santa Rosa'),
(1694, 185, 'Solol·'),
(1695, 185, 'Suchitepequez'),
(1696, 185, 'Totonicap·n'),
(1697, 185, 'Zacapa'),
(1699, 82, 'Amazonas'),
(1700, 82, 'Antioquia'),
(1701, 82, 'Arauca'),
...
(1716, 82, 'QuindÌo'),
(1717, 82, 'Risaralda'),
(1718, 82, 'San AndrÈs y Providencia'),
(1719, 82, 'Santander'),
(1720, 82, 'Sucre'),
(1721, 82, 'Tolima'),
...
(1746, 42, 'Jalisco'),
(1747, 42, 'MÈxico'),
(1748, 42, 'Michoac·n de Ocampo'),
(1749, 42, 'Morelos'),
(1750, 42, 'Nayarit'),
(1751, 42, 'Nuevo LeÛn'),
(1752, 42, 'Oaxaca'),
(1753, 42, 'Puebla'),
(1754, 42, 'QuerÈtaro de Arteaga'),
(1755, 42, 'Quintana Roo'),
(1756, 42, 'San Luis PotosÌ'),
(1757, 42, 'Sinaloa'),
(1758, 42, 'Sonora'),
(1759, 42, 'Tabasco'),
(1760, 42, 'Tamaulipas'),
...
(2075, 138, 'Valverde'),
(2076, 138, 'MarÌa Trinidad S·nchez'),
(2077, 138, 'Azua'),
(2078, 138, 'Santiago'),
(2079, 138, 'San CristÛbal'),
(2080, 138, 'Peravia'),
(2081, 138, 'ElÌas PiÒa'),
(2082, 138, 'Barahona'),
...
(2086, 138, 'San Juan'),
(2087, 138, 'MonseÒor Nouel'),
(2088, 138, 'Monte Cristi'),
(2089, 138, 'Espaillat'),
(2090, 138, 'S·nchez RamÌrez'),
(2091, 138, 'La Vega'),
(2092, 138, 'San Pedro de MacorÌs'),
...
(2099, 138, 'Pedernales'),
(2100, 138, 'Saman·'),
(2101, 138, 'Santiago RodrÌguez'),
(2102, 138, 'San JosÈ de Ocoa'),
(2103, 70, 'Chiba'),
(2104, 70, 'Ehime'),
(2105, 70, 'Oita'),
(2106, 85, 'Skopje'),
...
(2196, 69, 'Jeju'),
(2201, 25, 'Delhi'),
(2202, 81, 'RegiÛn de Los RÌos'),
(2203, 81, 'RegiÛn de Arica y Parinacota'),

(2204, 51, 'Usulut·n'),
(2205, 51, 'Moraz·n'),
(2206, 51, 'Chalatenango'),
(2207, 51, 'CabaÒas'),
(2208, 51, 'San Vicente');


select * from ra_paie_pais_estado where paie_codpai = 51