...
alter table dbo.ra_per_personas add per_id_usuario_blackboard int 
alter table dbo.pla_emp_empleado add emp_id_usuario_blackboard int 
go
...
as
	...
	t.nombres, t.apellidos, t.sexo, t.fecha_nacimiento
	from (
