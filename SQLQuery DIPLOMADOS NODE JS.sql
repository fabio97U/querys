...
--225358, 05-2540-2020, 0525402020, 10081998
--217864, 11-3128-2019, 1131282019, 15041995
--214958, 12-0492-2019, 1204922019, 28061999
--226737, 60-3850-2020, 6038502020, 10062002
...
declare @codins int
select @codins = ins_codigo from ra_ins_inscripcion where ins_codcil = 124 and ins_codper = 225358 
...
delete from dip_amd_alm_modulo where amd_codper = 225358
